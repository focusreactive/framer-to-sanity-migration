...
export const SITE = "images";
export const A1 = "0LKC1Ii8jJl4rPH5OY56H6z4PUg";
export const A2 = "F3kdpd2N0cToWV5huaZjjgM";

export const cdn = (path: string): string => `https://framerusercontent.com${path}`;
