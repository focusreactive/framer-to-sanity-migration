...
export type Verdict = "framer" | "unknown";
...
export function decideVerdict(scores: { framer: PlatformScore }): Verdict {
  if (scores.framer.score < CONFIDENCE_THRESHOLD || !scores.framer.hasTier1Strong) return "unknown";
  return "framer";
}
