...
export type AssetMeta = NonNullable<ReturnType<InputResolvers["assetMeta"]>>;

export function buildAssetPathBySha(projectPath: string, assets: MediaAssetsData | undefined): Map<string, AssetFile> {
